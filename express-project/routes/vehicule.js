...
router.get('/models/:brand',(req,res) => {
  ...
  axios.get(`https://www.carqueryapi.com/api/0.3/?cmd=getModels&make=${brand}`)
    .then(response => {
      console.log(response.data);
      const route = response.data;
     res.json(route.Models)
    })
    .catch(error => {
...
router.get('/brands',(req,res) => {
 return res.json([{"brand": "Seat", "models": ["Alhambra", "Altea", "Altea XL", "Arosa", "Cordoba", "Cordoba Vario", "Exeo", "Ibiza", "Ibiza ST", "Exeo ST", "Leon", "Leon ST", "Inca", "Mii", "Toledo"]},
...
router.post('/', uploaderSingle, AddVehiculeValidator, verifyToken,validate, AddVehiculeController);
